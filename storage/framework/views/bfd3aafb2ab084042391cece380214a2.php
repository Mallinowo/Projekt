...
<?php $__env->startSection('title', __('nav.profile')); ?>
...
<div class="profile-shell overflow-y-auto h-full p-6 flex flex-col gap-5 items-center scrollbar-thin" style="background:radial-gradient(ellipse at 50% -20%,rgba(168,85,247,.06),transparent 60%)">
    ...
    <div class="profile-success w-full max-w-3xl bg-green-900/30 border border-green-500/40 text-green-400 rounded-lg px-4 py-2 text-sm"><?php echo e(session('success')); ?></div>
    <?php endif; ?>

    <form method="POST" action="<?php echo e(route('profile.update')); ?>" class="w-full max-w-3xl">
        <?php echo csrf_field(); ?>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">

            <div class="profile-card bg-[#111118] border border-[#2a2a3a] rounded-xl overflow-hidden">
                <div class="px-4 py-2.5 border-b border-[#2a2a3a] font-mono text-xs uppercase tracking-widest text-[#5e5880]"><?php echo e(__('profile.info')); ?></div>
                <div class="p-5">
                    <div class="flex items-start gap-4 mb-4">
                        <div class="relative flex-shrink-0">
                            <div id="avWrap" class="w-20 h-20 rounded-full border-2 border-purple-400 overflow-hidden flex items-center justify-center bg-gradient-to-br from-purple-900 to-blue-900 cursor-pointer shadow-[0_0_20px_rgba(168,85,247,.3)]"
                                ...
                                <?php if($user->getAvatarUrl()): ?>
                                    <img src="<?php echo e($user->getAvatarUrl()); ?>" class="w-full h-full object-cover" id="avPreview">
                                <?php else: ?>
                                    <span class="text-3xl font-bold"><?php echo e(strtoupper(substr($user->name,0,1))); ?></span>
                                <?php endif; ?>
                            </div>
                        ...
                        <div class="flex-1">
                            <div class="mb-2">
                                <label class="field-label"><?php echo e(__('profile.username')); ?></label>
                                <input type="text" name="name" value="<?php echo e(old('name',$user->name)); ?>" required maxlength="30" class="field-input">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="grid grid-cols-2 gap-3 mb-3">
                        <div>
                            <label class="field-label"><?php echo e(__('profile.age')); ?></label>
                            <input type="number" name="age" value="<?php echo e(old('age',$user->age)); ?>" min="18" max="99" required class="field-input">
                        </div>
                        <div>
                            <label class="field-label"><?php echo e(__('profile.city')); ?></label>
                            <input type="text" id="cityInput" name="city" value="<?php echo e(old('city',$user->city)); ?>" required class="field-input" autocomplete="off">
                        </div>
                    </div>
                    <div class="mb-3">
                        <label class="field-label"><?php echo e(__('profile.subculture')); ?></label>
                        <select name="subculture" class="field-input">
                            <?php $__currentLoopData = ['emo' => 'Emo', 'scene' => 'Scene', 'goth' => 'Goth', 'punk' => 'Punk', 'metalhead' => 'Metalhead']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($val); ?>" <?php echo e($user->subculture === $val ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-3">
                        <div>
                            <label class="field-label"><?php echo e(__('profile.gender')); ?></label>
                            <select name="gender" class="field-input" required>
                                <option value="">— <?php echo e(__('profile.choose')); ?> —</option>
                                <option value="female" <?php echo e(old('gender', $user->gender) === 'female' ? 'selected' : ''); ?>><?php echo e(__('profile.gender_female')); ?></option>
                                <option value="male" <?php echo e(old('gender', $user->gender) === 'male' ? 'selected' : ''); ?>><?php echo e(__('profile.gender_male')); ?></option>
                                <option value="nonbinary" <?php echo e(old('gender', $user->gender) === 'nonbinary' ? 'selected' : ''); ?>><?php echo e(__('profile.gender_nonbinary')); ?></option>
                                <option value="other" <?php echo e(old('gender', $user->gender) === 'other' ? 'selected' : ''); ?>><?php echo e(__('profile.gender_other')); ?></option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            <label class="field-label"><?php echo e(__('profile.orientation')); ?></label>
                            <select name="orientation" class="field-input" required>
                                <option value="">— <?php echo e(__('profile.choose')); ?> —</option>
                                <option value="hetero" <?php echo e(old('orientation', $user->orientation) === 'hetero' ? 'selected' : ''); ?>><?php echo e(__('profile.orientation_hetero')); ?></option>
                                <option value="homo" <?php echo e(old('orientation', $user->orientation) === 'homo' ? 'selected' : ''); ?>><?php echo e(__('profile.orientation_homo')); ?></option>
                                <option value="bi" <?php echo e(old('orientation', $user->orientation) === 'bi' ? 'selected' : ''); ?>><?php echo e(__('profile.orientation_bi')); ?></option>
                                <option value="other" <?php echo e(old('orientation', $user->orientation) === 'other' ? 'selected' : ''); ?>><?php echo e(__('profile.orientation_other')); ?></option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        <label class="field-label"><?php echo e(__('profile.bio')); ?></label>
                        <textarea name="bio" rows="3" maxlength="500" class="field-input resize-none" placeholder="<?php echo e(__('profile.bio_placeholder')); ?>"><?php echo e(old('bio',$user->bio)); ?></textarea>
                    </div>
                </div>
            </div>

            <div class="profile-card bg-[#111118] border border-[#2a2a3a] rounded-xl overflow-hidden">
                <div class="px-4 py-2.5 border-b border-[#2a2a3a] font-mono text-xs uppercase tracking-widest text-[#5e5880]"><?php echo e(__('profile.match_prefs')); ?></div>
                <div class="p-5">
                    <div class="grid grid-cols-2 gap-3 mb-4">
                        <div>
                            <label class="field-label"><?php echo e(__('profile.pref_age_min')); ?></label>
                            <input type="number" name="preferred_age_min" min="18" max="99" class="field-input" value="<?php echo e(old('preferred_age_min', $user->preferred_age_min ?? 18)); ?>" required>
                            <?php $__errorArgs = ['preferred_age_min'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="field-error"><?php echo e($message); ?></p><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            <label class="field-label"><?php echo e(__('profile.pref_age_max')); ?></label>
                            <input type="number" name="preferred_age_max" min="18" max="99" class="field-input" value="<?php echo e(old('preferred_age_max', $user->preferred_age_max ?? 99)); ?>" required>
                            <?php $__errorArgs = ['preferred_age_max'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="field-error"><?php echo e($message); ?></p><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-4">
                        <div class="flex items-center justify-between mb-2">
                            <label class="field-label mb-0"><?php echo e(__('profile.pref_distance')); ?></label>
                        ...
                        <input
                            ...
                            max="500"
                            step="5"
                            value="<?php echo e(old('preferred_max_distance_km', $user->preferred_max_distance_km ?? 120)); ?>"
                            class="w-full accent-purple-500"
                            oninput="updateDistanceLabel(this.value)"
                        >
                        <?php $__errorArgs = ['preferred_max_distance_km'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="field-error"><?php echo e($message); ?></p><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        <div class="field-label mb-1"><?php echo e(__('profile.preferred_subcultures')); ?></div>
                        <p class="text-xs text-[#7f79a6] mb-3"><?php echo e(__('profile.preferred_subcultures_desc')); ?></p>
                        <p id="prefSubcultureHint" class="text-xs text-[#9b95be] mb-3"></p>
                        <div id="prefSubculturePicker" class="flex flex-wrap gap-2">
                            <?php $__currentLoopData = $subcultureOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button
                                type="button"
                                ...
                                data-subculture="<?php echo e($value); ?>"
                        ...
                        <div id="prefSubcultureInputs">
                            <?php $__currentLoopData = $preferredSubcultures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <input type="hidden" name="preferred_subcultures[]" value="<?php echo e($value); ?>" data-pref-sub="<?php echo e($value); ?>">
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                        <?php $__errorArgs = ['preferred_subcultures'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="field-error mt-2"><?php echo e($message); ?></p><?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                        <?php $__errorArgs = ['preferred_subcultures.*'];
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="profile-card bg-[#111118] border border-[#2a2a3a] rounded-xl overflow-hidden">
                <div class="px-4 py-2.5 border-b border-[#2a2a3a] font-mono text-xs uppercase tracking-widest text-[#5e5880]">
                    <?php echo e(__('profile.photos')); ?> <span class="text-[.44rem]">(max 6)</span>
                </div>
                <div class="p-5">
                    <div class="grid grid-cols-3 gap-2" id="phGrid">
                        ...
                        <div class="photo-tile aspect-square rounded-lg border border-[#2a2a3a] overflow-hidden relative group" data-photo-id="<?php echo e($photo->id); ?>">
                            <img src="/storage/<?php echo e($photo->path); ?>" class="w-full h-full object-cover">
                            <button type="button" onclick="deletePhoto(<?php echo e($photo->id); ?>, this.closest('[data-photo-id]'))"
            ...
            <div class="profile-card bg-[#111118] border border-[#2a2a3a] rounded-xl overflow-hidden">
                <div class="px-4 py-2.5 border-b border-[#2a2a3a] font-mono text-xs uppercase tracking-widest text-[#5e5880]"><?php echo e(__('profile.interests')); ?></div>
                <div class="p-5">
                    <div class="mb-4">
                    ...
                    <div class="rounded-xl border border-[#2a2a3a] bg-[#13131d] p-4">
                        <div class="text-sm font-semibold text-[#d6d1ee]"><?php echo e(__('onboarding.interests_selected_title')); ?></div>
                        ...
                        <div class="flex flex-wrap gap-2 mt-4 min-h-[44px]" id="interestsList">
                            ...
                            <span class="interest-tag" data-val="<?php echo e($interest->name); ?>">
                                <?php echo e($interest->name); ?> <span onclick="removeTag(this.parentElement)" class="cursor-pointer text-[#5e5880] hover:text-red-400 ml-1">X</span>
                                <input type="hidden" name="interests[]" value="<?php echo e($interest->name); ?>">
                            </span>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
            ...
            <div class="profile-card bg-[#111118] border border-[#2a2a3a] rounded-xl overflow-hidden">
                <div class="px-4 py-2.5 border-b border-[#2a2a3a] font-mono text-xs uppercase tracking-widest text-[#5e5880]"><?php echo e(__('profile.artists')); ?></div>
                <div class="p-5">
                    <div class="flex flex-wrap gap-2 mb-3" id="artistsList">
                        <?php $__currentLoopData = $user->artists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $artist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <span class="interest-tag" data-val="<?php echo e($artist->name); ?>">
                            <?php echo e($artist->name); ?> <span onclick="removeTag(this.parentElement)" class="cursor-pointer text-[#5e5880] hover:text-red-400 ml-1">X</span>
                            <input type="hidden" name="artists[]" value="<?php echo e($artist->name); ?>">
                        </span>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    <div class="flex flex-col sm:flex-row gap-2">
                        <input type="text" id="artistInput" class="field-input flex-1" placeholder="<?php echo e(__('profile.artist_placeholder')); ?>" maxlength="100" autocomplete="off" onkeydown="if(event.key==='Enter'){event.preventDefault();searchSpotifyArtists();}">
                        ...
                        <button type="button" onclick="searchSpotifyArtists()" class="bg-[#16161f] border border-[#2a2a3a] text-[#e2e0f0] px-4 py-2 rounded-lg text-sm font-semibold hover:border-purple-400 hover:text-purple-300 transition-colors w-full sm:w-auto">
                            <?php echo e(__('profile.spotify_search_btn')); ?>
                    ...
                    <div class="mt-4 rounded-xl border border-[#2a2a3a] bg-[#13131d] p-4">
                        <div class="text-sm font-semibold text-[#d6d1ee]"><?php echo e(__('profile.spotify_title')); ?></div>
                        <?php if($spotifyEnabled): ?>
                        <p id="spotifyInfo" class="text-sm text-[#9b95be] mt-1"><?php echo e(__('profile.spotify_search_only_desc')); ?></p>
                        <div id="spotifyResults" class="flex flex-wrap gap-2 mt-3"></div>
                        <?php else: ?>
                        <p class="text-sm text-[#9b95be] mt-1"><?php echo e(__('profile.spotify_not_configured')); ?></p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
...
const SPOTIFY_SEARCH_MIN = <?php echo json_encode(__('profile.spotify_search_min'), 15, 512) ?>;
const SPOTIFY_SEARCHING = <?php echo json_encode(__('profile.spotify_searching'), 15, 512) ?>;
const SPOTIFY_NOT_FOUND = <?php echo json_encode(__('profile.spotify_not_found'), 15, 512) ?>;
const SPOTIFY_ERROR = <?php echo json_encode(__('profile.spotify_error'), 15, 512) ?>;
const SPOTIFY_ADDED_TEMPLATE = <?php echo json_encode(__('profile.spotify_added', ['name' => '__NAME__']), 512) ?>;
const DISTANCE_LABEL_TEMPLATE = <?php echo json_encode(__('profile.distance_km', ['km' => '__KM__']), 512) ?>;
const PREF_SUBCULTURE_HINT_TEMPLATE = <?php echo json_encode(__('profile.selected_count', ['count' => '__COUNT__', 'max' => '__MAX__'])) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\malin\Desktop\altermatch\resources\views\profile\index.blade.php ENDPATH**/ ?>